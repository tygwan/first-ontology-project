...
| M7 | 2026-04-22 | 🟡 ENHANCEMENT | Hierarchy-based AWP scheduling — 12,009 objects with temporal dimension (Area/Unit/Discipline from Level 2/3/4 + schedule auto-generation) | 🔄 **In Progress** (DXTnavis hierarchy fallback 구현 중, schedule CSV export 예정) | [archive](findings/2026-04-22-M7-hierarchy-awp-scheduling/README.md) |
