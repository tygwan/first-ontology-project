...
| M7 | 2026-04-22 | 🟡 ENHANCEMENT | Hierarchy-based AWP scheduling — 12,009 objects with temporal dimension. **Audit caveat**: 비배관 분류 추정 / "~677 task" projection / "Level 2 = Area" 가설 일부 정정 (7번째 hallucination 사례), 구조적 결론 (24% 커버리지 갭) 은 유효 | 🔄 **In Progress** (audit 완료, DXTnavis hierarchy fallback 구현 + path-pattern AWP extractor 후속) | [archive](findings/2026-04-22-M7-hierarchy-awp-scheduling/README.md) |
