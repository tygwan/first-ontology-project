...
- **Upstream data**: DXTnavis v1.4.0 snapshot `2026-04-07`
- **Current phase**: Phase 1 complete (0, 1a, 1b, 1c, 1d, 1e). Phase 2 (OWL ontology) pending.
- **Primary targets**: Palantir Foundry (Developer Tier) + Power BI
...
- **R9 Provenance**: `SNAPSHOT = "2026-04-07"` pinned + lineage columns + audit scripts
...
- **Standards**: [dev-standards@0.1.0](https://github.com/tygwan/dev-standards)
